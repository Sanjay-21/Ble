...
//            }
    ...
    private class BLEScanCallback extends ScanCallback {
        ...
        BLEScanCallback(Map<String, BluetoothDevice> _scan_results) {
            ...
            System.out.println("Insideeeeeeeeeeeeeeeeee"+cb_scan_results);
        }
        @Override
        public void onScanResult(int _callback_type, ScanResult _result) {
            Log.d(TAG, "onScanResult");
            addScanResult(_result);
            System.out.println("Insideeeeeeeeeeeeeeeeee1"+_result);
        }
        ...
        private void addScanResult(ScanResult _result) {
            ...
            System.out.println("Device nnnnnnnnnnnnnnnnnnnnnnnnn"+device);
    ...
    private class GattClientCallback extends BluetoothGattCallback {
        ...
        private void readCharacteristic(BluetoothGattCharacteristic _characteristic) {
            ...
            for(Map.Entry m : map.entrySet()){
                ...
                System.out.println(m.getValue()==message);
                if(m.getValue()==message)
                {
                    System.out.println(m.getValue());
                    System.out.println("Heloooooooo"+message);
                    listener.onStatusMsg(message+" is present.");
                }
            }
